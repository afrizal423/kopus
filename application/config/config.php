...
*/
    ...
    // $config['base_url'] = 'https://teman-menulis-ikan.trydalang.io/';
...
|
*/
$config['encryption_key'] = 'k0p3r4s1-3v0t1ng-s3cur3-k3y-2026!*x#9';
...
$config['csrf_token_name'] = 'csrf_koperasi_token';
$config['csrf_cookie_name'] = 'csrf_koperasi_cookie';
